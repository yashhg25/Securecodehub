...
export default function Contactus() {
  return (
    <div className="bg-gray-900 text-white">
      <section className="flex flex-col lg:flex-row items-start justify-center lg:justify-between py-12 px-6 sm:px-10 lg:px-40 bg-black">

        <div className="lg:w-1/2 mb-10 lg:mb-0">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">Get In Touch</h2>
          <p className="mb-6 text-gray-400">Reach out for further inquiries or assistance.</p>
          <ul className="space-y-4">
            <li className="flex items-center">
              <svg className="w-6 h-6 mr-4 text-purple-500" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <div className="lg:w-1/2 bg-gray-800 p-6 sm:p-8 rounded-lg shadow-lg">
          <form action="#" method="POST">
            <div className="mb-4">
              ...
              <input
                ...
                id="firstName"
                name="firstName"
                className="w-full mt-2 p-3 border border-gray-700 rounded-lg bg-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-600"
